  ...
  with open(fn, 'rb') as f:
    while True:
      ...
      if p_data[0:9] == b'\xff\xff\xff\xff\xff\xff\xff\xff\xff':
        ts = get_uint32(p_data, 9)
      else:
        x = get_sint32(p_data, 0)/1000
        y = get_sint32(p_data, 4)/1000
        z = get_sint32(p_data, 8)/1000
        points.append([x,y,z])
  return points
...
if in_kind == 'fixed':
  points = get_binary_points(in_file)
